...
<script setup lang="ts">
  import { Bell, CircleUser, Coins, CreditCard, DollarSign, HistoryIcon, Home, LineChart, Menu, Package, Package2, PersonStanding,  ShoppingCart, Users } from 'lucide-vue-next'
